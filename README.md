...
[qdapDictionaries](http://trinker.github.com/qdapDictionaries/) is an R package that contains tools associated with the qdap package that may be useful outside of the context of text analysis.
